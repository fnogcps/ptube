<template>
    <div
        class="antialiased bg-gray-900 w-full min-h-screen text-slate-300 relative py-4">
        <div
            ...
            <div id="menu" class="bg-white/10 col-span-3 rounded-lg p-4">
                ...
                <router-link to="/#" class="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-5 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
                    ...
                    <div>
                        <p
                            class="font-medium group-hover:text-indigo-400 leading-4">
                            Name Lorem
                        </p>
                    </div>
                </router-link>
                    ...
                    <router-link
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p
                                    class="text-slate-400 text-sm hidden md:block">
                                    Data overview
                                </p>
                            </div>
                        </div>
                ...
                <card class="w-full flex flex-col">
                    ...
                    <div class="flex flex-row mt-2 gap-2">
                        ...
                        <div clas="flex flex-col">
                            ...
                            <a
                                class="text-gray-400 text-xs mt-2 hover:text-gray-100"
                                href="#">
                                Web Dev Simplified
                            </a>
